...
describe('YAMLTestProcessor', () => {
    ...
    describe('constructor', () => {
        ...
        test('should handle testRoot with relative path', () => {
            mockFs.existsSync.mockReturnValue(false);
            ...
            expect(processor.projectRoot).toBe('/project/root');
            expect(processor.testRoot).toBe('/project/root/examples');
        });

        test('should handle testRoot with absolute path', () => {
            mockFs.existsSync.mockReturnValue(false);
            
            const options = {
                projectRoot: '/project/root',
                testRoot: '/absolute/test/path'
            };
            
            processor = new YAMLTestProcessor(options);
            
            expect(processor.projectRoot).toBe('/project/root');
            expect(processor.testRoot).toBe('/absolute/test/path');
        });

        test('should default testRoot to projectRoot when not specified', () => {
            mockFs.existsSync.mockReturnValue(false);
            ...
            expect(processor.projectRoot).toBe('/project/root');
            expect(processor.testRoot).toBe('/project/root');
        });
    });
